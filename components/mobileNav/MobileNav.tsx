    ...
    <AnimatePresence>
      {contextValue?.openMobileNav ? (
        <motion.nav
          ...
          className="fixed left-0 bottom-0 z-50 w-[60%] h-[90%]  border-2 border-t-[#5F6368] border-x-0 border-b-0 flex flex-col overflow-none bg-darkmode transition ease-in-out delay-150 "
        >
